    ...
    const data = [
      {
        roleId: "101",
        role: "Administrator",
        description: "Lorem ipsum dolor sit amet consectetur. Massa vitae pharetra arcu nisl et.",
  ...
  return (
    <>
      ...
      <div className="overflow-x-auto shadow rounded-lg">
        <TableDataComp columns={columns} data={data} actions={actions}>{isAdmin ? eyeOpen : ""}</TableDataComp>
      </div>
    </>
  );
};
